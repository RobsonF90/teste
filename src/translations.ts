...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    casting: {
      ...
      heroSubtitle: "Work at one of the most dynamic and exciting nightlife destinations in Albufeira. We offer top conditions for charismatic and motivated talent.",
      badgeLocation: "Albufeira Strip • Algarve",
      badgeIncome: "High Earnings & Tips",
      badgeSafe: "Safe & Professional",
      vacanciesTitle: "Casting & Auditions",
      vacanciesSubtitle: "Discover the premier opportunity for dancers and stage performers at our luxury club.",
      roleDancersTitle: "Dancers",
      roleDancersDesc: "Stage performances in a glamorous and sophisticated atmosphere. We offer the highest commissions and daily tips in the Algarve.",
      roleDancersTag: "Apply Here",
      roleHostessTitle: "Public Relations / Hostess",
      roleHostessDesc: "Welcoming VIP guests, hosting private lounge tables with elegance, charisma, and exceptional hospitality.",
      roleHostessTag: "VIP Lounge & PR",
      roleBarTitle: "Bar Staff",
      roleBarDesc: "Crafting signature cocktails and serving premium champagne in a high-energy bar with a dynamic team.",
      roleBarTag: "Premium Bar",
      benefitsTitle: "What We Offer",
      benefitsSubtitle: "We provide an elite working environment designed for your success, safety, and comfort.",
      benefit1Title: "High Earnings & Commissions",
      benefit1Desc: "Attractive and punctual pay, daily/weekly commission splits, and excellent tips.",
      benefit2Title: "Safe & Professional Environment",
      benefit2Desc: "24/7 private security, respectful management, and complete physical and personal protection.",
      benefit3Title: "Schedule Flexibility",
      benefit3Desc: "Organized shifts allowing you to balance work with personal projects or study.",
      benefit4Title: "Accommodation Option",
      benefit4Desc: "Quality living arrangements and assistance available for staff relocating or seasonal work.",
      benefit5Title: "Absolute Confidentiality",
      benefit5Desc: "100% discreet recruiting process, privacy protocols, and personal data protection.",
      ctaSectionTitle: "Fast Direct Application",
      ctaInstructionsTitle: "Send us via WhatsApp:",
      ctaInstruction1: "Full Name",
      ctaInstruction2: "Age (+18)",
      ctaInstruction3: "2 Recent Photos (Portrait & Full Body)",
      whatsappBtn: "Apply via WhatsApp",
      emailLabel: "Alternative Contact Email",
      legalNotice: "Strictly for individuals 18 years of age or older. 100% discreet and confidential process.",
    },
  },
  pt: {
    splash: {
    ...
    casting: {
      heroTitle: "Faça Parte da Nossa Equipa",
      heroSubtitle: "Trabalhe num dos locais mais dinâmicos, prestigiados e rentáveis da vibrante vida noturna de Albufeira. Procuramos profissionais carismáticas e motivadas para integrar a nossa equipa de topo.",
      badgeLocation: "Albufeira Strip • Algarve",
      badgeIncome: "Ganhos Acima da Média",
      badgeSafe: "Ambiente Seguro e Profissional",
      vacanciesTitle: "Casting & Audições",
      vacanciesSubtitle: "Oportunidade de topo para dançarinas e performers de palco no clube noturno mais exclusivo de Albufeira.",
      roleDancersTitle: "Dançarinas",
      roleDancersDesc: "Apresentações e performances em palco numa atmosfera glamorosa e sofisticada. Oferecemos as comissões e gorjetas mais elevadas de Albufeira.",
      roleDancersTag: "Candidate-se aqui",
      roleHostessTitle: "Relações Públicas / Hostess",
      roleHostessDesc: "Acolhimento de clientes VIP, acompanhamento no lounge exclusivo e animação de mesas com distinção, simpatia e elegância.",
      roleHostessTag: "Lounge VIP & RP",
      roleBarTitle: "Staff de Bar",
      roleBarDesc: "Preparação e serviço de cocktails de autor e champanhes num balcão dinâmico, elegante e de alta energia.",
      roleBarTag: "Balcão Premium",
      benefitsTitle: "O que Oferecemos",
      benefitsSubtitle: "Proporcionamos todas as condições para que trabalhe com tranquilidade, reconhecimento e alto retorno.",
      benefit1Title: "Ganhos Elevados e Comissões",
      benefit1Desc: "Remuneração atrativa e pontual, excelentes comissões por objetivos e as melhores gorjetas do Algarve.",
      benefit2Title: "Ambiente Seguro e Profissional",
      benefit2Desc: "Equipa de segurança privada permanente, respeito absoluto por todas as colaboradoras e ambiente protegido.",
      benefit3Title: "Flexibilidade de Horários",
      benefit3Desc: "Turnos organizados para permitir a conciliação com os seus estudos, vida pessoal ou projetos paralelos.",
      benefit4Title: "Opção de Alojamento",
      benefit4Desc: "Disponibilizamos apoio e opção de alojamento confortável para colaboradoras deslocadas ou vindas de fora da região.",
      benefit5Title: "Total Confidencialidade",
      benefit5Desc: "Processo de recrutamento 100% discreto, confidencial e com total respeito pela sua privacidade e imagem.",
      ctaSectionTitle: "Candidatura Rápida e Direta",
      ctaInstructionsTitle: "Envie-nos pelo WhatsApp:",
      ctaInstruction1: "O seu Nome Completo",
      ctaInstruction2: "A sua Idade (+18)",
      ctaInstruction3: "Duas (2) Fotos recentes (Rosto e Corpo Inteiro)",
      whatsappBtn: "Candidatar via WhatsApp",
      emailLabel: "E-mail alternativo de contacto",
      legalNotice: "Exclusivo para maiores de 18 anos. Processo 100% discreto e confidencial.",
    },
  },
};
