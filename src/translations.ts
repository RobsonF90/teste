...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    home: {
      ...
      heroTagline: "Where luxury meets world-class entertainment, signature cocktails, and unforgettable nights.",
      ...
      exp2Title: "Signature Cocktails & Premium Spirits",
      ...
      tonightShowDesc: "An exclusive performance featuring beautiful international dancers, elegant choreography, and an unforgettable nightlife experience. Show starts at 23:30.",
      viewFullMenu: "View Full Experiences & Menu",
      hoursTeaser: "Doors Open At 22:00",
      hoursTeaserDesc: "Join us early for pre-show cocktails under the starry night.",
    },
    shows: {
      ...
      scheduleDesc: "Doors open every day at 22:00. Main stage shows begin at 23:30 and run intermittently throughout the night, with the final act culminating in a high-energy DJ set to dance under golden lights until 06:00.",
    ...
    contact: {
      ...
      hoursValue: "Every day: 22:00 - 06:00 AM",
  ...
  pt: {
    ...
    home: {
      heroTitle: "MARDIGRAS",
      heroSubtitle: "NIGHTCLUB",
      heroTagline: "Onde o luxo encontra entretenimento de classe mundial, cocktails de autor e noites inesquecíveis.",
      ...
      exp2Title: "Cocktails de Autor & Bebidas Premium",
      ...
      tonightShowDesc: "Uma performance exclusiva com belas bailarinas internacionais, coreografias elegantes e uma experiência noturna inesquecível. O espetáculo começa às 23:30.",
      viewFullMenu: "Ver Menu Completo e Experiências",
      hoursTeaser: "Portas Abrem às 22:00",
    ...
    shows: {
      ...
      scheduleDesc: "As portas abrem todos os dias às 22:00. Os shows no palco principal começam às 23:30 e decorrem intermitentemente ao longo da noite, culminando com um set de DJ de alta energia para dançar sob as luzes douradas até às 06:00.",
    ...
    contact: {
      ...
      hoursValue: "Todos os dias: 22:00 às 06:00",
